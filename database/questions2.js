const questions2 = [
  { 
    questionText: "It is difficult to successfully tamper with transactions within a blockchain",
    
    options: [ 
    "1. The blockchain is not duplicated",
    "2. Each participating node has a copy of the authentic transaction",
    ],
          answer: "2. Each participating node has a copy of the authentic transaction",
    },
    { 
    ...
    options: [ 
    "1. Programs that are stored on Blockchain and gets executed when a business logic is met",
    "2. Deployed on all Blockchain Nodes",
